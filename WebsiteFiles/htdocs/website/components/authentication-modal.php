<div class="authentication_modal_container">
    <div class="authentication_modal_content_container">
        <div class="modal_design_container">
            ...
            <img class="design_image" src="/website/graphics/img/authentication_design_image.png" alt="design plant image">
        </div>
        <div class="authentication_form_container">
            ...
            <div class="form_category_design_bar"></div>
            <div class="authentication_form_fields_container">
                <div class="form_login_field_container">
                    <form class="login_form_container" action="/website/post/verification.php" method="post">
                    ...
                    <form class="login_form_container" action="/website/post/verification.php" method="post">
                        <div class="fistlastname_container">
                            <div>
                                ...
                                <input class="firstname_input" type="text" name="firstname" value="" placeholder="First Name">
                            </div>
                            <div>
                                <p class="lastname_title">Last Name</p>
                                <input class="lastname_input" type="text" name="lastname" value="" placeholder="Last Name">
                            </div>
                        </div>
                        <p class="email_title">Email</p>
                        <input class="email_input" type="text" name="email" value="" placeholder="Email">
                        ...
                        <input class="confirmpassword_input" type="password" name="confirm-password" placeholder="Confirm Password">
                        <?php 
                            if(isset($_GET['message']) && !empty($_GET['message']))
                                echo '<h3 class="error-message">' . htmlspecialchars($_GET['message']) . '</h3>';
                        ?>
