...
?>
<script src="/website/js/captcha.js"></script>
<script src="/website/js/authentication-modal.js"></script>
<div class="authentication_modal_container <?php echo $modalOpened ? "" : "closed"; ?>">
    <div class="authentication_modal_background"></div>
    <div class="authentication_modal_main_content_container">
