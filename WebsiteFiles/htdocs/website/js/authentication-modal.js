window.addEventListener("load", function () {
    setTimeout(() => {
        ...
        document.querySelector(".authentication_modal_background").addEventListener("click", (event) => {
            document.querySelector(".authentication_modal_container").classList.add("closed");
            enableScroll();
        });

        document.querySelector(".authentication_register_button").addEventListener("click", (event) => {
            document.querySelector(".authentication_form_fields_container").classList.add("switched");
            document.querySelector(".form_category_design_bar").classList.add("selected");
        });

        document.querySelector(".authentication_login_button").addEventListener("click", (event) => {
            document.querySelector(".authentication_form_fields_container").classList.remove("switched");
            document.querySelector(".form_category_design_bar").classList.remove("selected");
        });
