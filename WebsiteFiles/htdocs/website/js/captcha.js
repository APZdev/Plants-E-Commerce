window.addEventListener("load", function () {
    setTimeout(() => {
        ...
        const captchaModalButton = document.querySelector(".captcha_checkbox_title_container");
        ...
        const captchaDraggablesContainers = document.querySelectorAll(".draggable_container, .starting_draggable_container");
        ...
        function checkGameState() {
            ...
            if (
                ...
                const firstContainerValue = parseInt(firstContainer.firstChild.innerHTML);
                const secondContainerValue = parseInt(secondContainer.firstChild.innerHTML);
                const thirdContainerValue = parseInt(thirdContainer.firstChild.innerHTML);
                const fourthContainerValue = parseInt(fourthContainer.firstChild.innerHTML);
